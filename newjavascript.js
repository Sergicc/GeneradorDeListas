...
function showDetails(event) {
    ...
    if ($(event.target).hasClass('cañon')) {
        $("#perfil").html("<table><tr class='perfil'><td class='td'></td><td class='td'>M</td class='td'><td style='padding: 6px'>HA</td><td style='padding: 6px'>HP</td><td class='td'>F</td><td class='td'>R</td><td class='td'>H</td><td class='td'>I</td><td class='td'>A</td><td class='td'>L</td></tr>" +
                "<tr><td class='td-left'>Cañon</td><td class='td'>-</td><td class='td'>-</td><td class='td'>-</td><td class='td'>-</td><td class='td'>7</td><td class='td'>3</td><td class='td'>-</td><td class='td'>-</td><td class='td'>-</td></tr>" +
...
function addChaman() {
    ...
    var pRegalos = 0;
    var tipo = "hero";
    $("#listHero").append("<img nombre='Chamán del Rebaño' nombre2='Chamán del Rebaño' tipo=" + tipo + " puntos=" + coste + " pObjetos=" + pObjetos + " pRegalos=" + pRegalos + " arma=" + arma + " montura=" + montura + " armaMagic=" + armaMagic + " talisman=" + talisman + " hechizado=" + hechizado + " arcano=" + arcano + " level=" + level + " saber=" + saber + " rCorona=" + rCorona + " rPielN=" + rPielN + " rDiablo=" + rDiablo + " rZancada=" + rZancada + " rPellejo=" + rPellejo + " rColmillos=" + rColmillos + " rRuna=" + rRuna + " rSentidos=" + rSentidos + " rPielS=" + rPielS + " rPielH=" + rPielH + " class='hero chaman' src='img warhgen/Chaman.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
...
function addCarro() {
    var coste = 80;
    var tipo = "basic";
    $("#listBasic").append("<img nombre='Carro de Tuskgors' nombre2='Carro de Tuskgors' tipo=" + tipo + " puntos=" + coste + " arma='no' class='basic carro' src='img warhgen/Carro de Tuskgors.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addGors() {
    ...
    var musico = "no";
    var tipo = "basic";
    $("#listBasic").append("<img nombre='Rebaño de Gors' nombre2='Rebaño de Gors' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " emboscada=" + emboscada + " campeon=" + campeon + " estandarte=" + estandarte + " estandarteMag=" + estandarteMag + " musico=" + musico + " class='basic gor' src='img warhgen/Gors.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addUngors() {
    ...
    var musico = "no";
    var tipo = "basic";
    $("#listBasic").append("<img nombre='Rebaño de Ungors' nombre2='Rebaño de Ungors' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " emboscada=" + emboscada + " campeon=" + campeon + " estandarte=" + estandarte + " musico=" + musico + " class='basic ungor' src='img warhgen/Ungors.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addMastines() {
    ...
    var mutacion = "no";
    var tipo = "basic";
    $("#listBasic").append("<img nombre='Mastines del Caos' nombre2='Mastines del Caos' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " vanguardia=" + vanguardia + " pellejoE=" + pellejoE + " mutacion=" + mutacion + " class='basic mastin' src='img warhgen/Mastines.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
...
function addArpias() {
    ...
    var emboscada = "no";
    var tipo = "esp";
    $("#listEsp").append("<img nombre='Arpías' nombre2='Arpías' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " emboscada=" + emboscada + " class='esp arpia' src='img warhgen/Arpias.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addCentigors() {
    ...
    var musico = "no";
    var tipo = "esp";
    $("#listEsp").append("<img nombre='Centigors' nombre2='Centigors' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " armadura=" + armadura + " campeon=" + campeon + " estandarte=" + estandarte + " musico=" + musico + " class='esp centigor' src='img warhgen/Centigors.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
...
function addTrolls() {
    ...
    var arma = "no";
    var tipo = "esp";
    $("#listEsp").append("<img nombre='Trolls del Cau' nombre2='Trolls del Cau' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " class='esp troll' src='img warhgen/Trolls.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addQuimera() {
    ...
    var arma = "no";
    var tipo = "esp";
    $("#listEsp").append("<img nombre='Quimera' nombre2='Quimera' tipo=" + tipo + " puntos=" + coste + " arma=" + arma + " aliento=" + aliento + " pielR=" + pielR + " sudor=" + sudor + " class='esp quimera' src='img warhgen/Quimera.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addOgrosD() {
    ...
    var campeon = "no";
    var tipo = "esp";
    $("#listEsp").append("<img nombre='Ogros Dragón' nombre2='Ogros Dragón' tipo=" + tipo + " puntos=" + coste + " cextras=" + costeextras + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " campeon=" + campeon + " class='esp ogroD' src='img warhgen/OgrosDragon.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addGarragors() {
    ...
    var arma = "no";
    var tipo = "esp";
    $("#listEsp").append("<img nombre='Rebaño de Garragors' nombre2='Rebaño de Garragors' tipo=" + tipo + " puntos=" + coste + " cInd=" + costeInd + " cantidad=" + cantidad + " arma=" + arma + " class='esp pumba' src='img warhgen/Garragors.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
...
function addCigor() {
    ...
    var arma = "no";
    var tipo = "sing";
    $("#listSing").append("<img nombre='Cigor' nombre2='Cigor' tipo=" + tipo + " puntos=" + coste + " arma=" + arma + " class='sing cigor' src='img warhgen/Cigor.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addEscuerzo() {
    ...
    var arma = "no";
    var tipo = "sing";
    $("#listSing").append("<img nombre='Escuerzo Alado' nombre2='Escuerzo Alado' tipo=" + tipo + " puntos=" + coste + " arma=" + arma + " class='sing escuerzo' src='img warhgen/Escuerzo.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addGigante() {
    ...
    var arma = "no";
    var tipo = "sing";
    $("#listSing").append("<img nombre='Un tio muy grande' nombre2='Un tio muy grande' tipo=" + tipo + " puntos=" + coste + " arma=" + arma + " class='sing gigante' src='img warhgen/Gigante.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addEngendro() {
    ...
    var arma = "no";
    var tipo = "sing";
    $("#listSing").append("<img nombre='Engendro del Caos' nombre2='Engendro del Caos' tipo=" + tipo + " puntos=" + coste + " arma=" + arma + " class='sing engendro' src='img warhgen/Engendro.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
function addShaggoth() {
    ...
    var mej = 0;
    var tipo = "sing";
    $("#listSing").append("<img nombre='Ogro Dragón Shaggoth' nombre2='Ogro Dragón Shaggoth' tipo=" + tipo + " puntos=" + coste + " arma=" + arma + " armadura=" + armadura + " gran=" + gran + " mej=" + mej + " class='sing shaggoth' src='img warhgen/Shaggoth.png'/>");
    incrementarPuntos(coste, tipo);
    actualizarEvents();
}
